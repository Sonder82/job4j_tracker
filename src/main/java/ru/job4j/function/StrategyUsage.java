...
/**
 * Класс опиывает совместную работу шаблона проектирования стратегия в сочетании с функциональными интерфейсами
...
public class StrategyUsage {
    /**
     * Метод выполняет проверки с стороками
     * @param pred функциональный интерфей Predicate
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Строка после преобразования: " + usage.transform(str -> str.toUpperCase(), "aBCdEfghKLmnpRstU"));
        System.out.println(
                "Строка после преобразования: " + usage.transform(
                        str -> str.concat("работает корректно."), "Строка после преобразования: "));
        System.out.println(
        "Строка после преобразования: " + usage.transform(str -> str.trim(), "    aBC dEfghK Lmnp RstU        "));
    }
}
